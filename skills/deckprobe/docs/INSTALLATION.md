# DeckProbe Skill v0.3.0: install and first use
...
Install the immutable `v0.3.0` ref only after the release gate has published
...
it against the immutable `v0.3.0` ref after that tag is published:
...
The v0.3.0 wrapper accepts files up to 1 GiB (1,073,741,824 bytes, inclusive).
